...
import slide_image_1 from "/gallary/img_1.png";
...
const Gallary = () => {
  return (
    <div className="relative w-full h-[100vh]  bg-gray-100 text-white grid place-items-center z-10  overflow-hidden ">
      ...
      <div className=" flex flex-col md:flex-row md:gap-4 md:justify-center md:items-center text-center uppercase font-jan-brady  h-full  z-10 ml-[-700px] md:ml-0  md:mt-10 ">
